...
def tes():
	...
	print("\033[1;97m       ┈╰━━╮"+Fore.RED+"┊▕╱╲▏┊"+Fore.WHITE+"╭━━┴╥╯\033[1;96m["+Back.WHITE+Fore.RED+"Copyright By ©KenzoXploit ©2022 Friday 4 March \033[00m"+Fore.RED+"\033[1;96m]")
	print("")
	print(""+Fore.RED+"   [+] "Fore.WHITE+"Time Local:\033[1;92m"+localtime)
	print(""+Fore.RED+"   [+] "Fore.WHITE+"Instagram:\033[1;92mbit.ly/KenzoxploitIG")
	print(""+Fore.RED+"   [+] "Fore.WHITE+"IP Kamu:\033[1;92m"+IP)
	print(""+Fore.RED+"   [+] "Fore.WHITE+"Pengguna:\033[1;92m1032 Orang")
	print("")
tes()
